...
export abstract class Default {
    public static readonly APP_TITLE: string = 'Hackaton'
    ...
    public static readonly SWAGGER_URI: string = ''
    ...
    // MongoDB
    public static readonly MONGODB_URI: string = 'mongodb://127.0.0.1:27017/hackaton'
    public static readonly MONGODB_URI_TEST: string = 'mongodb://127.0.0.1:27017/hackaton-test'
